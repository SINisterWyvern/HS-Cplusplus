...
int main()
{
 int iX, iY;
    ...
    testWindow.ChangeTitle("This Kewl Demo");
    ...
    // Draws a yellow vertical line with a pen thickness of 5 pixels
    ...
    testWindow.SetPen(0.0, 0.0, 0.0, 20);
    testWindow.DrawLine(250, 10, 250, 400);

	testWindow.SetPen(0.5, 0.5, 0.5, 15);
	testWindow.DrawLine(0, 250, 600, 250);
    ...
    testWindow.SetPen(5.0, 2.5, 0.0, 10);    
    testWindow.SetBrush(0.0, 5.0, 5.0);
    testWindow.DrawRectangle(70, 70, 400, 400, FILLED, 20, 20);
    
    // Draw an INVERTED rectangle
    testWindow.DrawRectangle(150, 5, 500, 300, INVERTED);
    ...
    testWindow.DrawCircle(300, 220, 200, INVERTED);
